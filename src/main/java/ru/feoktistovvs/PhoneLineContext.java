...
//
    ...
    //
        ...
        static
        {
            Idle = new PhoneLineFSM_Default.PhoneLineFSM_Idle("PhoneLineFSM.Idle", 46);
            Ready = new PhoneLineFSM_Default.PhoneLineFSM_Ready("PhoneLineFSM.Ready", 47);
            Conversation = new PhoneLineFSM_Default.PhoneLineFSM_Conversation("PhoneLineFSM.Conversation", 48);
            Warning = new PhoneLineFSM_Default.PhoneLineFSM_Warning("PhoneLineFSM.Warning", 49);
