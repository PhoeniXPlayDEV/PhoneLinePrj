...
public class PhoneLineSample extends javax.swing.JFrame {
    ...
    public PhoneLineSample() {
        ...
        _stateMap.put(PhoneLineContext.PhoneLineFSM.Warning, new Transition[] { _warning_onHookTransition, _warning_invalidNumberTransition, _warning_validNumberTransition });
